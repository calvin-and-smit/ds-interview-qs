...
created_at	datetime
event_name	varchar
In the table above, column `event_name` represents either ('event', 'post', 'cancel') for when a user starts a post (enter), ends up canceling it (cancel), or ends up posting it (post).
